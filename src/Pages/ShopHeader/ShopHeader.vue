  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      <img
        ...
        :src="info.avatar"
      />
      <div class="header-content" @click="showShopInfo">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="showShopSupport">
      <div class="discounts-left">
        <div  calss="activity"  :class="supportClasses[info.supports[0].type]">
          <span class="content-tag">
    ...
    <div class="shop-brief-modal "  v-show="showShop" >
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span class="iconfont icon-close"  @click="showShopInfo"></span>
        </div>
      </div>
    ...
    <transition name="act">
     <div class="activity-sheet" v-show="showSupport">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close" @click="showShopSupport">
